...
function mapState(d) {
  ...
  return {
    ...
    // positiv = Entladen / Ausgang, negativ = Laden über PV
    measure_power:
      outputPower !== null || pvPower !== null
        ? (outputPower || 0) - (pvPower || 0)
        : null,
    ...
    marstek_wifi_signal: toNumber(d.ts),
